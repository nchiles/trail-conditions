...
router.get("/wahlfield", cacheWithRedis('60 minutes'), function(req, res) {
    ...
    .then(function(data) {
        ...
        return request("http://api.wunderground.com/api/" + apiKey1 + "/conditions/bestfct:1/q/" + wahlfieldPws3 + ".json");
    })
    .then(function(data) {
    ...
    //pws:KMICOMST7
        return request("http://api.wunderground.com/api/" + apiKey2 + "/history_" + todayLessOne + "/q/" + wahlfieldPws1 + ".json");
    })
    .then(function(data) {
        ...
        return request("http://api.wunderground.com/api/" + apiKey2 + "/history_" + todayLessTwo + "/q/" + wahlfieldPws1 + ".json");
    })
    .then(function(data) {
        ...
        return request("http://api.wunderground.com/api/" + apiKey2 + "/history_" + todayLessThree + "/q/" + wahlfieldPws1 + ".json");
    })
    .then(function(data) {
     ...
     //pws:KMICOMST9
        return request("http://api.wunderground.com/api/" + apiKey2 + "/history_" + todayLessOne + "/q/" + wahlfieldPws2 + ".json");
    })
    .then(function(data) {
        ...
        return request("http://api.wunderground.com/api/" + apiKey2 + "/history_" + todayLessTwo + "/q/" + wahlfieldPws2 + ".json");
    })
    .then(function(data) {
        ...
        return request("http://api.wunderground.com/api/" + apiKey2 + "/history_" + todayLessThree + "/q/" + wahlfieldPws2 + ".json");
    })
    .then(function(data) {
    ...
    //pws:KMISPART13
        return request("http://api.wunderground.com/api/" + apiKey2 + "/history_" + todayLessOne + "/q/" + wahlfieldPws3 + ".json");
    })
    .then(function(data) {
        ...
        return request("http://api.wunderground.com/api/" + apiKey2 + "/history_" + todayLessTwo + "/q/" + wahlfieldPws3 + ".json");
    })
    .then(function(data) {
        ...
        return request("http://api.wunderground.com/api/" + apiKey2 + "/history_" + todayLessThree + "/q/" + wahlfieldPws3 + ".json");
    })
    .then(function(data) {
